            ...
            <div class="col-sm-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <small class="text-muted">Written By: <a href="profile.php?username=<?php echo htmlentities($item['author'])?>"><?php echo htmlentities($item['author']) ?> </a> On <?php echo ($item['date_time']) ?>
